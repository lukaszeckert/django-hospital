...
urlpatterns = [
   ...
   # path('search/', views.search, name='search'),
    ...
    path('hospitalromm/(<int:pk>/', views.HospitalRommUpdateView.as_view(success_url="/hospital/hospitalromm/"),
         name='hospitalromm_details'),
    path('hospitalromm/add/', views.HospitalRommCreateView.as_view(success_url="/hospital/hospitalromm/"),
         name='hospitalromm_add'),
    path('hospitalromm_delete/<int:pk>)', views.HospitalRommDeleteView.as_view(success_url="/hospital/hospitalromm/"),
